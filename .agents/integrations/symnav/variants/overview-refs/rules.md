...
Sequences that work well (examples, not requirements): `overview` → `refs`. Use symnav early to orient, mid-task to locate and understand symbols, and before editing shared code to see what depends on it.
